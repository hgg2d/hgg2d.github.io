...
class Chan {
  ...
  html() {
    ...
    this.quicklinksToggle = this.addElement('a', quicklinksToggleDiv, { class: 'hgg2d__quicklinksToggle' });
    this.quicklinksToggle.append('quicklinks settings');
    const navLinks = document.querySelector('.navLinks.desktop');
    navLinks.append(quicklinksToggleDiv);
    this.quicklinksToggle.addEventListener('click', (e) => {
