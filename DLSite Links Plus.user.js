...
(() => {
    ...
    const RJCode = /((?:(?:dlsite|www|http|maniax)[^>\s]+)?[rv][je]a?((\d{3})\d{3})(?:\.html)?)/gi
    ...
    const CSS = {
        hgg2dCSS: ('' +
            ...
            '.previewBar { position: fixed; right: 3em; width: 6em; bottom: 12em; z-index: 7; padding: 0; margin: 0; max-height: 35%; overflow-y: auto; overflow-x: hidden; }\n' +
            ...
            '.hgg2dOverlay { background: rgba(0,0,0,0.8); display: none; height: 100%; left: 0; position: fixed; top: 0; width: 100%; z-index: 6; }\n' +
            '.hgg2dBox { background: #D6DAF0; position: fixed; top: 20%; left: 20%; width:50%; padding: 2em; border: 1em solid #34345C; overflow: hidden; }\n' +
    ...
    const Firstrun = {
        init: () => {
            ...
            div.innerHTML = ('<div class="hgg2dBox">\n' +
                ...
                '         <td><a rel="noreferrer" target="_blank" href="http://www.dlsite.com/maniax/announce/=/product_id/RJ197797" class="lewds">RJA197797</a> and <a rel="noreferrer" target="_blank" href="http://www.dlsite.com/maniax/announce/=/product_id/RJ197797" class="lewds">http://www.dlsite.com/maniax/announce/=/product_id/RJ197797</a></td>\n' +
                '     </tr>\n' +
                '     <tr>\n' +
    ...
    const createRJ = (el, match, text, code) => {
        ...
        let circleType = []
        let workType = ''
        if (text.includes('announce') || /[rv]ja/i.test(text))
            workType = 'announce'
        else
            workType = 'work'
        if (text.includes('VJ'))
